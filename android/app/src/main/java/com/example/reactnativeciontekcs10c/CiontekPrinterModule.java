...
public class CiontekPrinterModule extends ReactContextBaseJavaModule {
  ...
  public String getName() {
    return "CiontekPrinterModule";
  }

  @ReactMethod
  public void testingModule(String name, Callback callback) {
    callback.invoke(name+" ==> "+"Called OK~");
    Log.d("CiontekPrinterModule", "Testing with param: ");
  }
